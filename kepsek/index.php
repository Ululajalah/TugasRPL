...
<head>
	...
	<title>Kepala Asrama | Aplikasi Presensi</title>
		...
		<footer class="footer">
				<div class="container">
					<div class="copyright ml-auto">
						&copy; <?php echo date('Y');?> Absensi Santri Ponpes QH Bagu  (<a href="index.php">Ahmad Ulul Azmi </a> | 2022)
					</div>				
				</div>
			</footer>
		</div>
