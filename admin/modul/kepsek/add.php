<div class="page-inner">
          <div class="page-header">
            <h4 class="page-title">Kepala Asrama</h4>
            <ul class="breadcrumbs">
              ...
              <li class="nav-item">
                <a href="#">Data Kepala Asrama</a>
              </li>
              <li class="separator">
                <i class="flaticon-right-arrow"></i>
              </li>
              <li class="nav-item">
                <a href="#">Tambah Kepala Asrama</a>
              </li>
            </ul>
          </div>
          <div class="row">
                ...
                <div class="col-lg-8">
                  <div class="card">
                    <div class="card-header d-flex align-items-center">
                      <h3 class="h4">Form Entry Kepala Asrama</h3>
                    </div>
                    <div class="card-body">
						<form action="?page=kepsek&act=proses" method="post" enctype="multipart/form-data">
							...
							<div class="form-group">
								<label>Nama Kepala Asrama</label>
