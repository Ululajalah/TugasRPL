		...
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue">
				...
				<a href="dashboard.php" class="logo">
					...
					<b class="text-white">Ponpes QH Bagu</b>
				</a>
								...
								<ul class="nav nav-collapse">
									...
									<li>
										<a href="?page=master&act=mapel">
											<span class="sub-item">Mata Diniyah</span>
										</a>
									</li>
								...
								<ul class="nav nav-collapse">
									<li>
										<a href="?page=kepsek&act=add ">
											<span class="sub-item"> Tambah Kepala Asrama </span>
										</a>
									</li>
									<li>
										<a href="?page=kepsek">
											<span class="sub-item"> Daftar Kepala Asrama </span>
										</a>
									</li>
								</ul>
							</div>
		...
		<footer class="footer">
				<div class="container">
					<div class="copyright ml-auto">
						&copy; <?php echo date('Y');?> Absensi Ponpes Qamarul Huda Badaruddin Bagu(<a href="index.php">Ahmad Ulul Azmi </a> | 2022)
					</div>				
				</div>
			</footer>
		</div>
