								...
								<div class="card-body">
									<div class="card-title">
										<center>
											...
											<br>
											<b>Ponpes Qamarul Huda Badaruddin Bagu</b>
										</center>
									</div>
									<div class="card-category">
										<center>
										Jl. H. Badaruddin, Bagu, Kec. Pringgarata, Lombok Tengah, NTB
										<br>Email : PonpesBagu@gmail.com
										</center>
									</div>
									...
									<div class="tab-content mt-2 mb-3" id="pills-with-icon-tabContent">
										...
										<div class="tab-pane fade" id="pills-contact-icon" role="tabpanel" aria-labelledby="pills-contact-tab-icon">
											<p>
												...
												Aplikasi Absensi santri ini dibuat untuk mendokumentasikan kehadiran santri, Aplikasi sangat Mudah digunakan (Berbasis Web)
											</p>
										</div>
									</div>
								</div>
